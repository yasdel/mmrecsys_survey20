...
|------|-------|----------|-----------|---------------|-------|-------|
|2017|**A hybrid recommendation system considering visual information for predicting favorite restaurants.**|WWW|restaurant|[Link](https://dl.acm.org/doi/pdf/10.1145/2671188.2749381)||source NA||
