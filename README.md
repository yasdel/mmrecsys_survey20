...
|------|-------|----------|-----------|---------------|-------|-------|-------|
|2015|**A Semantic HybridApproach for Sound Recommendation.**|WWW|SoundTrack|[Link](https://dl.acm.org/doi/10.1145/2740908.2742775)||[DBpedia](http://dbpedia.org/)  <br> [WordNet] (https://wordnet.princeton.edu/)|[FreeSound](http://linkeddata.org/) ||
