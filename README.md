...
### Sounds
| Year  | Authors | Title       |Venue  | Target Item    | Paper        |Code |Data|
|------|-------|-------|------|-----------|---------------|-------|-------|
|2015| Oramas et al.|**A Semantic Hybrid Approach for Sound Recommendation.**|WWW|![2917767](https://user-images.githubusercontent.com/12104758/82207553-4b48b400-990a-11ea-8155-bd09d9a1bf66.png)|[Link](https://dl.acm.org/doi/10.1145/2740908.2742775)|--|[DBpedia](http://dbpedia.org/)<br>[WordNet](https://wordnet.princeton.edu/)<br>[FreeSound](http://linkeddata.org/)||
...
|2019| Smith et al. |**Towards a Hybrid RecommendationSystem for a Sound Library.**|IUI|SoundTrack|[Link](http://ceur-ws.org/Vol-2327/IUI19WS-MILC-5.pdf)||[DS_name](TBA)|||


### Music
| Year  | Title       |Target Item  | Venue    | Link        |Code | Data|
|------|-------|----------|-----------|---------------|-------|-------|
|2008|**An Efficient HybridMusic Recommender System Using an Incrementally Trainable Probabilistic Generative Model.**|ACM Tr.ATLP|![music_artist](https://user-images.githubusercontent.com/12104758/82208027-15f09600-990b-11ea-9a3c-dc3aec09e4cc.png)|[Link](https://ieeexplore.ieee.org/document/4432655)||[DS_name](TBA)||
