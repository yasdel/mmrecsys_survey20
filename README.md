...
|------|-------|----------|-----------|---------------|-------|-------|
|2015|**Harvesting Multiple Sources for User Profile Learning: aBig Data Study.**|ICMR|tag|[Link](https://dl.acm.org/doi/pdf/10.1145/2671188.2749381)||[NUS-MSS](http://nusmultisource.azurewebsites.net/)||
